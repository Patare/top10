...
const Bc = () => {
  const handleMouseOver = (event) => {
    event.target.style.width = '310px'; 
    event.target.style.height="310px"
  };
...
<Container maxWidth="lg" sx={{mt:5}}>
  ...
  <Grid item xs={3}>
    <img onMouseOver={handleMouseOver} onMouseOut={handleMouseOut} style={{transition: 'width 0.5s'}} src="https://images.top10.com/f_auto,q_auto/v1/production/foundation-entities/uploads/photo/Untitleddesign86.20221025070645.jpg" width={"300px"} height={"300px"} alt="" />
  </Grid>
  <Grid item xs={3} >
  <img onMouseOver={handleMouseOver} onMouseOut={handleMouseOut} style={{transition: 'width 0.5s'}} src="https://images.top10.com/f_auto,q_auto/v1/production/foundation-entities/uploads/photo/Untitleddesign86.20221025070645.jpg" width={"300px"} height={"300px"} alt="" />
  </Grid>
